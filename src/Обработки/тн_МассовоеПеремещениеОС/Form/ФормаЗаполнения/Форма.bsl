...
Процедура ЗагрузитьВАРМ(Команда)
    ...
    НеНайденныеКоды = ПолучитьНеНайденныеКодыОС(СписокКодов);
    
    СтруктураВыбора = Новый Структура();
    СтруктураВыбора.Вставить("ТаблицаОС", ТаблицаОС);
    СтруктураВыбора.Вставить("НеНайденныеКоды", НеНайденныеКоды);
...
&НаКлиенте
Функция ПолучитьНеНайденныеКодыОС(СписокКодов)
    ...
    Для каждого Код Из СписокКодов Цикл
        ...
        Если НайденКод = Неопределено Тогда
        	НеНайденныеКоды.Добавить(Код);
        КонецЕсли; 
    КонецЦикла;
    
   Возврат НеНайденныеКоды; 
КонецФункции
