...
Процедура ТаблицаАдресПолучательНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыОткрытияФормы.Вставить("ВидКонтактнойИнформации", 
...
Процедура Заполнить(Команда)
    ОткрытьФорму("Обработка.тн_МассовоеПеремещениеОС.Форма.ФормаЗаполнения", Новый Структура, ЭтаФорма,УникальныйИдентификатор);
КонецПроцедуры
...
Процедура СоздатьДокументы(Команда)
    Для Каждого Строка Из Таблица Цикл
        ...
        ЗаполненынужныеПоля = ЗначениеЗаполнено(Строка.ОсновноеСредство)
                            ...
                            И ?(ЗначениеЗаполнено(Строка.СтатьяРасходов),ЗначениеЗаполнено(Строка.АналитикаРасходов) , Истина)
                            И ?(ЗначениеЗаполнено(Строка.СтатьяРасходовНалог),ЗначениеЗаполнено(Строка.АналитикаРасходовНалог), Истина);                            
