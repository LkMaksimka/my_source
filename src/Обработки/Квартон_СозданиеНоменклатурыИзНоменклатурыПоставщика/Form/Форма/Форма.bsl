...
Процедура ВидНоменклатурыПриИзменении(Элемент)
	НоменклатурнаяГруппа = ВидНоменклатурыПриИзмененииНаСервере();
КонецПроцедуры
...
&НаСервере
Функция ВидНоменклатурыПриИзмененииНаСервере()
	Группа = РегистрыСведений.кв_ПравилаУказанияГруппыДляНоменклатуры.ПолучитьГруппуНоменклатуры(ВидНоменклатуры);
	Возврат Группа;
КонецФункции
